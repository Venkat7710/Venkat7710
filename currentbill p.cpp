...
void eb::c_cal()
{
	...
	cout<<"enter consumer name-"<<endl;
	cin>>cname;
	cout<<"enter previous month reading-"<<pmr<<endl;
	cin>>pmr;
	cout<<"enter current month reading-"<<cmr<<endl;
	cin>>cmr;
	u=cmr-pmr;
	cout<<"units-"<<u<<endl;
	if(u<=100)
...
void eb::display()
{
	...
	cout<<"enter consumer name-"<<endl;
	cin>>cname;
	cout<<"enter previous month reaading-"<<pmr<<endl;
	cin>>pmr;
	cout<<"enter current month reading-"<<cmr<<endl;
	cin>>cmr;
	u=cmr-pmr;
...
int main()
{
	...
	switch (choice)
	{
		case 1:
			...
			break;
			default:
				cout<<"enter domestic or commercial-"<<endl;		
	}
	return 0;
}
